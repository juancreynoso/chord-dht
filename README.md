...
para el proyecto de aprobación de Telecomunicaciones y Sistemas
Distribuidos: mantener el estado (conectado/desconectado) de usuarios,
...
requeridas está en [`arquitectura.pdf`](./arquitectura.pdf).
...
| `chord_rpc.py` | Serialización JSON de los mensajes RPC (incluye `NodeRef`) |
...
Para terminar: `Ctrl+C` o `kill <pid>` desde otra terminal.

### Interactuar con el anillo ya levantado
...
La demostración completa —formación del anillo con siete nodos, escrituras y
lecturas desde nodos arbitrarios, alta de un nodo en caliente y caída del nodo
dueño de una clave— está documentada con las transcripciones de terminal reales
